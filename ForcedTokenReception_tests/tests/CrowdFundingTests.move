...
module testing::crowdfundingTests{
    ...
    fun test_forced_coin_reception(fund: signer, donor_a: signer, donor_b: signer, framework: signer) {
        ...
        //coin::register<coin::FakeMoney>(&fund); <====== Commenting out this line prevents a coinstore being created at the accounts address which means that the account can't store FakeMoney coins
